...
import { EbolaContaminationComponent } from './ebola-contamination/ebola-contamination.component';


@NgModule({
  declarations: [SanteEbolaComponent, SanteEbolaListComponent, SanteEbolaHomeComponent, EtatAccessibiliteComponent, AccessibiliteComponent, EbolaProvinceComponent, EbolaContaminationComponent],
  imports: [
    CommonModule,
