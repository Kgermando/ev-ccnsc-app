...
@Component({
  selector: 'app-relation-ac-secure',
  templateUrl: './relation-ac-secure.component.html',
  styleUrls: ['./relation-ac-secure.component.scss']
})
export class RelationAcSecureComponent implements OnInit {
  ...
  processDataEtat(entries) {
    ...
    entries.forEach(element => {
      if (this.data[element.RelationActeurSecuritSocieteCivile]) {
        this.data[element.RelationActeurSecuritSocieteCivile] += 1;
      } else {
        this.data[element.RelationActeurSecuritSocieteCivile] = 1;
      }
    });
