...
@Component({
  selector: 'app-admin-env-airproteger',
  templateUrl: './admin-env-airproteger.component.html',
  styleUrls: ['./admin-env-airproteger.component.scss']
})
export class AdminEnvAirprotegerComponent implements OnInit {
  ...
  processDataEtat(entries) {
    ...
    entries.forEach(element => {
      if (this.data[element.AirProtege]) {
        this.data[element.AirProtege] += 1;
      } else {
        this.data[element.AirProtege] = 1;
      }
    });
